function z_display(image,x_name,y_name,x_size,y_size,rotation,alpha=1){
	...
	draw_sprite_ext(image,0,x_name+x_offset,y_name+y_offset,scale_variable_x,scale_variable_y,rotation*-1,c_white,alpha)
